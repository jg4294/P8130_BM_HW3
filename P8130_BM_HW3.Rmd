...
We find: |Z_stat| = 0.01776018 > Z_crit = -1.644854, reject H0, and conclude that the true mean of average IQ score of IVY League is less than 270. The conclusion is 1 in this one random sample case.
```{r part(2.1)}
set.seed(88)
